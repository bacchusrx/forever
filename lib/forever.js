...
forever.plugins     = (function(){
  var plugins = {};
  plugins.__defineGetter__('logger', function() { return require('./forever/plugins/logger') });
  plugins.__defineGetter__('watch',  function() { return require('./forever/plugins/watch')  });
  return plugins;
})();
